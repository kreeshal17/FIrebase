...
@Composable
fun LoginPage(navController: NavController,authViewModel: AuthViewModel,modifier: Modifier = Modifier)
{
    ...
    LaunchedEffect(authState.value) {
        ...
        {
           is  AuthState.Authenticated -> navController.navigate(Constant.home)
    ...
    {
        Text(text="Login Page", style = TextStyle.Default,fontSize =30.sp
        )
